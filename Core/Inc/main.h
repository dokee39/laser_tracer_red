...
/* Private defines -----------------------------------------------------------*/
#define adjust_left_Pin GPIO_PIN_4
#define adjust_left_GPIO_Port GPIOA
#define adjust_right_Pin GPIO_PIN_5
#define adjust_right_GPIO_Port GPIOA
...
#define adjust_up_Pin GPIO_PIN_10
#define adjust_up_GPIO_Port GPIOB
#define adjust_down_Pin GPIO_PIN_11
#define adjust_down_GPIO_Port GPIOB
